  ...
  render(){    
      ...
      <nav class="app-top-nav">
        <a href="/" @click="${anchorRoute}">Home</a>
          ${this.user.accessLevel == 2 ? html`
            <a href="/newHaircut" @click="${anchorRoute}">Add Haircut</a> 
          ` : ``}
    ...
    <sl-drawer class="app-side-menu" placement="start" class="drawer">
      ...
      <nav class="app-side-menu-items">
        ...
        ${this.user.accessLevel == 2 ? html`
          <a href="/newHaircut" @click="${this.menuClick}">Add Haircut</a> 
        ` : ``}
        <a href="/hairdressers" @click="${this.menuClick}">Hairdressers</a>
        <a href="/haircuts" @click="${this.menuClick}">Haircuts</a>
        <a href="/favourites" @click="${this.menuClick}">Favourite Haircuts</a>
